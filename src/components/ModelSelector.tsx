...
export const ModelSelector: React.FC<ModelSelectorProps> = ({ modelOptions, selectedModel, showModelSelector, onModelChange }) => {
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`flex items-center justify-center w-10 h-10 rounded-lg ${selectedModel === model.id ? 'bg-[#C9520D] text-white' : 'bg-gray-700 text-gray-300'}`}>{model.icon}</div>
                  <div>
                    <p className="text-sm font-medium text-gray-100 text-left">{model.name}</p>
