            ...
            {isDesignMode ? (
              ...
              >
                {attachments.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-2" data-oid=":s1mp:7">
                    {attachments.map((file, idx) => (
                      <div
                        key={idx}
                        className="p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow flex items-center space-x-2"
                        data-oid="zxupxg."
                      >
                        <Paperclip
